        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-100">
                <tr>
                    ...
                    <td class="px-4 py-3"><?php echo e($trip->total_seats); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->available_seats); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->departure_point); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->price); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->description); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->category->name); ?></td>
                    <td class="px-4 py-3"><?php echo e($trip->status); ?></td>
