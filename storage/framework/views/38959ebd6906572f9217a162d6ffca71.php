<?php $__env->startSection('title', 'Pilgrims and Revenue'); ?>
...
<?php $__env->startSection('content'); ?>
    <form method="GET" action="<?php echo e(route('admin.reports.pilgrims-revenue')); ?>" class="admin-panel admin-panel--padded filter-bar">
        ...
        <div class="filter-actions">
            ...
            <a href="<?php echo e(route('admin.reports.pilgrims-revenue')); ?>" class="link-action link-action--view">Reset</a>
        </div>
    </form>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="is-numeric"><?php echo e($row['bookings_count']); ?></td>
                        <td class="is-numeric"><?php echo e($row['pilgrims_count']); ?></td>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Xacademy Tasks\TripGo\resources\views/admin/reports/pilgrims-revenue.blade.php ENDPATH**/ ?>