...
<?php $__env->startSection('content'); ?>
    <div class="mb-4 flex items-center justify-between gap-4">
        <form method="GET" action="<?php echo e(route('admin.destinations.index')); ?>" class="flex-1 max-w-sm">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by name..."
                class="w-full rounded border-gray-300 text-sm">
        </form>

        <a href="<?php echo e(route('admin.destinations.create')); ?>" class="rounded bg-gray-900 px-4 py-2 text-white">
            + New Destination
        </a>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-4 py-3"><?php echo e($destination->name); ?></td>
                        <td class="px-4 py-3"><?php echo e($destination->trips_count); ?></td>
                        <td class="px-4 py-3 space-x-2 text-right">
                            <a href="<?php echo e(route('admin.destinations.show', $destination)); ?>" class="text-blue-600 hover:underline">View</a>
                            <a href="<?php echo e(route('admin.destinations.edit', $destination)); ?>" class="text-amber-600 hover:underline">Edit</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Xacademy Tasks\TripGo\resources\views/admin/destinations/index.blade.php ENDPATH**/ ?>