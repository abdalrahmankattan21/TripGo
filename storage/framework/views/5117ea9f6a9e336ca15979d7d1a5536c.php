<?php $__env->startSection('title', 'Most Popular Destinations'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => ['items' => [
        ...
        ['label' => 'Most Popular Destinations'],
...
<?php $__env->startSection('content'); ?>
    <form method="GET" action="<?php echo e(route('admin.reports.popular-destinations')); ?>" class="admin-panel admin-panel--padded filter-bar">
        ...
        <div class="filter-actions">
            ...
            <a href="<?php echo e(route('admin.reports.popular-destinations')); ?>" class="link-action link-action--view">Reset</a>
        </div>
    </form>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Xacademy Tasks\TripGo\resources\views/admin/reports/popular-destinations.blade.php ENDPATH**/ ?>