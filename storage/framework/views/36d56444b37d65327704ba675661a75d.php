...
<?php $__env->startSection('content'); ?>
    <div class="rounded-lg bg-white p-6 shadow">
        <?php if($destination->image): ?>
            <img src="<?php echo e(Storage::url($destination->image)); ?>" alt="<?php echo e($destination->name); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Xacademy Tasks\TripGo\resources\views/admin/destinations/show.blade.php ENDPATH**/ ?>