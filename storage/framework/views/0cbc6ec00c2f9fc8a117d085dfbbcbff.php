<div class="form-grid">
    ...
    <div class="form-field form-field--full">
        ...
        <?php if(!empty($destination?->image)): ?>
            <img src="<?php echo e($destination->image == "image" ? asset('images/destination.jpg') : Storage::url($destination->image)); ?>" alt="<?php echo e($destination->name); ?>" class="form-thumb">
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\final\TripGo\resources\views/admin/destinations/_form.blade.php ENDPATH**/ ?>