...
<div class="container">
    ...
    <form action="<?php echo e(route('admin.guides.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('admin.guides.index')); ?>" class="btn btn-secondary">إلغاء</a>
    </form>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Xacademy Tasks\TripGo\resources\views/admin/guides/create.blade.php ENDPATH**/ ?>