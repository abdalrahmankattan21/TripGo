...
@section('content')
    <form method="GET" action="{{ route('admin.reports.popular-destinations') }}" class="admin-panel admin-panel--padded filter-bar">
        ...
        <div class="filter-actions">
            ...
            <a href="{{ route('admin.reports.popular-destinations') }}" class="link-action link-action--view">Reset</a>
        </div>
    </form>
